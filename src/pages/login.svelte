...
-->
<div
  class="bg-black min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8"
>
  <div class="max-w-md w-full space-y-8">
    <div>
      <img
        class="mx-auto m-5 h-20 md:h-40 max-w-auto"
        src={Logo}
        alt="Workflow"
      />
      <h2 class="text-center text-3xl font-extrabold text-red-500 mt-0">
      ...
      <div>
        ...
        >
          <span class="absolute left-0 inset-y-0 flex items-center pl-3">
            ...
            <svg
              class="h-5 w-5 text-red-100 group-hover:text-red-400"
